                    ...
                    <div id="slide1" className="carousel-item relative w-full">
                        <div className="flex flex-col lg:flex-row-reverse p-4 lg:p-24 gap-20">
                            <motion.div
                                ...
                                className="space-y-7 flex-1">
                                <h2 className="font-poppins  text-xl text-secondary lg:text-4xl font-bold">Kacchi is Layers of partially boiled basmati rice and raw meat</h2>
